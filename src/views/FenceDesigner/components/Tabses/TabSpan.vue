<template>
    <b-row>
        <b-col>
            <b-row>
                <b-col>
                    <label>{{ $t('views.fenceDesigner.tabMain.tabSpan.tabObject.height') }} ({{ heightCentimeters }} {{ $store.state.unitOfMeasure }}):</label>
                    <b-form-input v-model="tabObject.height" min="0" type="number" step="1" :placeholder="$t('views.fenceDesigner.tabMain.tabSpan.tabObject.height')"></b-form-input>
                </b-col>
                <b-col>
