<template>
    <b-row>
        <b-col>
            <b-row>
                <b-col>
                    <label>{{ $t('views.fenceDesigner.tabMain.tabGate.tabObject.width') }} ({{ $store.state.unitOfMeasure }}):</label>
                    <b-form-input v-model="tabObject.width" type="number" step="1" :placeholder="$t('views.fenceDesigner.tabMain.tabGate.tabObject.width')"></b-form-input>
                </b-col>
            </b-row>
        </b-col>
    </b-row>
